...
Though this we see in order of significance with p-values, TOI \`{r} I{p_toi}\`, (Very Significant), Sv% \`{r} p_sv\`, (Significant), wins \`{r} I{p_wins}\`, (Not Significant). with values being less than 0.0001, to 0.01, to 0.05 to 0.1 are the levels we see of significance. Seeing this, we are encourage to remove Wins from the model. Let us see if this is the case with a step-wise regression model.
